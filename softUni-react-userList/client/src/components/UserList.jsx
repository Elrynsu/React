...
export default function UserList() {
    ...
    const userDeleteGoneHandler = async (userId) => {
    ...
    return (
        <section className="card users-container">
            ...
            {showCreate && (<AddNewUser
                hideUser={hideUserHandler}
            ...
            {userDeleteId && (<UserDelete 
                hideDelete={hideDeleteHandler}
                onDelete={userDeleteGoneHandler}
                userId={userDeleteId}
            />)}
